...
pub trait VdbCollider: RayCast + PointQuery {

}

macro_rules! impl_parry {
    ($ty: tt) => {
        impl<ROOT: Node> parry3d::query::RayCast for $ty<ROOT>
        where
        ...
        impl<ROOT: Node> parry3d::query::PointQuery for $ty<ROOT>
        where
            [(); ROOT::LEVEL as usize]: Sized,
        {
        ...
        impl<ROOT: Node> parry3d::shape::Shape for $ty<ROOT>
        where
            [(); ROOT::LEVEL as usize]: Sized,
        {
            ...
            fn as_typed_shape(&self) -> parry3d::shape::TypedShape {
                parry3d::shape::TypedShape::Custom(10)
            }
...
impl_parry!(Tree);
impl_parry!(ImmutableTree);
impl_parry!(ImmutableTreeSnapshot);
