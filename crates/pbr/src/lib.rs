...
use bevy::{app::{App, Plugin, PostUpdate, Startup}, ecs::{query::With, schedule::IntoSystemConfigs}, window::PrimaryWindow};
pub use pipeline::*;
...
impl Plugin for PbrRendererPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_device_extension::<rhyolite::ash::khr::push_descriptor::Meta>().unwrap();
    }
