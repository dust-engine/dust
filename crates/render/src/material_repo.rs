...
impl TextureRepo {
    ...
    pub fn upload(
        ...
        let (image, image_allocation, image_allocation_info) = allocator.create_image(
            ...
            .unwrap();
        let (staging_buffer, staging_buffer_allocation, staging_buffer_allocation_info) = allocator.create_buffer(
        ...
        let indices = {
            ...
            for (i, material) in self.materials
                .iter()
                .enumerate() {
        ...
        let buffer_copies: Vec<_> = self.materials
            .iter()
            .zip(indices.iter())
            .enumerate()
